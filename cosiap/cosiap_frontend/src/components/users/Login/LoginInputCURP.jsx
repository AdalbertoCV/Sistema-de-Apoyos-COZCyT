    ...
    return (
        <>
            <FormInput
                ...
                errors={errors}
            />
            <img src="http://localhost:5173/src/assets/IconsImg/user.svg" alt="Icono Correo" className={`absolute left-3 top-1/2 transform ${errors ? "-translate-y-6" : "-translate-y-1/2"} w-5 h-5`} />
        </>
